  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2'>
      <div>
        ...
        <button className='p-2 mt-5 font-semibold bg-blue-500 px-4 rounded-full hover:scale-105 hover:border-blue-500 hover:bg-black hover:border-2 hover:text-blue-500 transition-all'>Explore Cars</button>
      </div>
      <div>
